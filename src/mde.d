...
mde.o gcm.cache/mde.gcm: mde:editorpane.c++m mde:component.c++m \
 mde:previewpane.c++m mde:mde_view.c++m mde:mde_control.c++m \
 mde:mde_model.c++m mde:footer.c++m mde:header.c++m
mde.c++m: gcm.cache/mde.gcm
.PHONY: mde.c++m
gcm.cache/mde.gcm:| mde.o
CXX_IMPORTS += mde:editorpane.c++m mde:component.c++m \
 mde:previewpane.c++m mde:mde_view.c++m mde:mde_control.c++m \
 mde:mde_model.c++m mde:footer.c++m mde:header.c++m
